...
'''
this script is run as part of the build to parse out the README.md file into usable information for the about page in the module.

A file called _readme.txt is generated in the /sededu/ folder for inclusion in the deployment.
'''
